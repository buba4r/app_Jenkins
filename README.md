...
--------------------
These instructions were tested on IntelliJ IDEA . You can get it from https://www.jetbrains.com/idea/
...
You should now have a Jetty server running on localhost:8085. Navigate to http://localhost:8080 to play with the application
